...
{
    public class FieldDocGenerator : IFieldDocGenerator
    {
        readonly IDocGeneratorUtility utility;
        readonly ICommentIDGenerator idGen;

        public FieldDocGenerator(IDocGeneratorUtility utility, ICommentIDGenerator idGen)
        {
        ...
        public FieldDoc GenerateFieldDoc(FieldInfo fieldInfo)
        {
            ...
            return new FieldDoc(GenerateMemberDoc(fieldInfo), GenerateConstValue(fieldInfo));
        }

        public MemberDoc GenerateMemberDoc(FieldInfo member)
        {
            Check.Ref(member);
